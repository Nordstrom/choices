...
elwin/elwin.pb.go: elwin/elwin.proto
	protoc -I./elwin -I${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis --go_out=plugins=grpc:${GOPATH}/src elwin/elwin.proto
...
storage/storage.pb.go: storage/storage.proto
	protoc -I./storage -I${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis --go_out=plugins=grpc:${GOPATH}/src storage/storage.proto
...
intake/intake.pb.go: intake/intake.proto storage/storage.proto
	protoc -I./intake -I./storage -I${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis --go_out=plugins=grpc:${GOPATH}/src intake/intake.proto
