...
/*
Package elwin is a reverse proxy.
...
// RegisterElwinHandlerFromEndpoint is same as RegisterElwinHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterElwinHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterElwinHandler(ctx, mux, conn)
}

// RegisterElwinHandler registers the http handlers for service Elwin to "mux".
...
func RegisterElwinHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("POST", pattern_Elwin_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
